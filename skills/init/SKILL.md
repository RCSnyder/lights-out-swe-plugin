---
name: init
description: Scaffold the Lights Out SWE harness (copilot-instructions.md, preferences.md, scaffolding/, .gitignore) into the current repo. Run once to set up a new repository before starting the pipeline.
