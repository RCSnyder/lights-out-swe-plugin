...
| Custom agents       | Optional — define project-specific agents in `.github/agents/` as roles emerge during BUILD (separate from the lo-swe plugin's agents) |
| Scaffolding         | Persists — provenance record for iteration and audit                                                                                   |
...
| Custom agents       | Yes — define project-specific agents in `.github/agents/` as roles emerge during BUILD (separate from the lo-swe plugin's agents) |
