...
> **Custom agent**: This workflow is normally driven by the `Lights Out SWE: Reconcile` custom agent. Switch to that agent (or run from the main agent if the dropdown is unavailable) before executing the steps below.
